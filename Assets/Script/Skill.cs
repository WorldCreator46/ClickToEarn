...
public class Skill : MonoBehaviour
{
    ...
    {
        new List<string>(){ "악력 증가", "1000000", "2", "10", "0"},
        new List<string>(){ "시력 증가", "1000000000", "2", "20", "0"},
        new List<string>(){ "근력 증가", "1000000000000", "3", "30", "0"},
        new List<string>(){ "체력 증가", "1000000000000000", "3", "50", "0"}
    };
